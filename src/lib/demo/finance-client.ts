...
const accounts: AccountRow[] = ledgerData.accounts.map((account) => {
  ...
  return {
    ...
    liability_expected_payoff_date: null,
    liability_interest_rate_percentage: null,
    liability_is_overdue: null,
    liability_kind: account.type === "credit" ? "credit_card" : null,
    liability_last_payment_amount: null,
    liability_last_payment_date: null,
    liability_loan_name: null,
    liability_loan_status: null,
    liability_next_payment_amount: null,
    liability_origination_date: null,
    liability_origination_principal_amount: null,
    liability_past_due_amount: null,
    liability_repayment_plan: null,
