  ...
  return (
    <section className={styles.reimbursementPanel} aria-label="Reimbursement linking">
      <div className={styles.reimbursementPanelHeader}>
        ...
        <strong>{hasExistingLinks ? "Linked received inflow" : "Link this positive inflow"}</strong>
        <p>
          Match reimbursement income to an existing reimbursement record. Partial links keep the remaining balance visible;
          raw provider rows stay unchanged.
        </p>
      </div>
